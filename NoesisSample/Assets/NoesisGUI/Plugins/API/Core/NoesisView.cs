...
namespace Noesis
{
    ...
    public class View
    {
        ...
        /// <summary>
        /// Notifies that a vertical axis is being actioned.
        /// The value will typically range from -1.0 to 1.0, indicating that axis is fully pulled down
        /// or pushed up completely. But this value might be scaled by user requirements
        /// <summary>
        public virtual void AxisY(float value)
        {
            Noesis_View_AxisY_(CPtr, value);
        }
        #endregion
        ...
        static void Noesis_View_AxisY_(HandleRef view, float value)
        {
            Noesis_View_AxisY_(view, value);
            Error.Check();
        }
        ...
        [DllImport(Library.Name)]
        static extern void Noesis_View_AxisY(HandleRef view, float value);
